...
n_estimators_class_grid = [10, 100, 500]
learning_rate_class_grid = [0.01, 0.05, 0.1]
max_depth_class_grid = [1, 3, 5]
...
numGridPts = num_classGrid*num_regGrid
        ...
        for c3 in max_depth_class_grid:
            for r1 in n_estimators_reg_grid:
                for r2 in max_depth_reg_grid:
                    ...
                    params = [c1, c2, c3, r1, r2, reg_threshold]
...
gridSearch_data_dict = {'Params':params_store, 'Profit':profit_store}
gridSearch_df = pd.DataFrame(data=gridSearch_data_dict)
gridSearch_df.to_csv('hyperparam_gridSearch.csv', index=False)
