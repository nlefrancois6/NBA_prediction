...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 21:41:38 2021
...
url = 'https://www.sportsbookreview.com/betting-odds/nba-basketball/money-line/?date=20151027'
...
regex = re.compile('wrapper-2tuQL')
...
## get html code for odds based on desired line type and date
    ...
    #https://www.sportsbookreview.com/betting-odds/nba-basketball/money-line/?date=20151027
...
soup, time_ml = soup_url('money-line', todays_date)
df = parse_and_write_data(soup,todays_date,time_ml)
"""
"""
...
a = []
for item in soup.find_all('div', {'class': '_3h0tU'}):
